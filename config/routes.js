...
module.exports.routes = {
  ...
  'GET /lessons/:virtualPageSlug?': { action: 'lessons/view-available-lessons' },

  'GET /users/:virtualPageSlug?':        { action: 'users/view-users' },
  ...
  'POST /api/v1/users/add-user': { action: 'users/add-user' },
  'POST /api/v1/users/block-user': { action: 'users/block-user' },

  'POST /api/v1/lesson/add-lesson': { action: 'lessons/add-lesson' },
  'DELETE /api/v1/lesson/remove-lesson': { action: 'lessons/remove-lesson' },

  'GET   /api/v1/lesson/:id/photo':                   { action: 'lessons/download-photo', skipAssets: false },
  'GET   /api/v1/lesson/:id/track':                   { action: 'lessons/download-track', skipAssets: false },
